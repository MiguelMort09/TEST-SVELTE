<script lang="ts">
    ...
    function toggleDark() {
        currentMode === "light" ? setDarkMode() : setLightMode();
    }
</script>
<!-- App Header Wrapper-->
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
                ...
                <div id="notification-wrapper" class="flex">
                    ...
                    >
                        ...
                        <span class="absolute -top-px -right-px h-3 w-3 items-center justify-center {hasNotification?'flex':'hidden'}">
                            <span
                                class="absolute inline-flex h-full w-full animate-ping rounded-full bg-secondary opacity-80"
                            />
                            <span class="inline-flex h-2 w-2 rounded-full bg-secondary" />
                        </span>
                    </button>
                    <div id="notification-box" class="popper-root hidden">
                        <div
                            ...
                            <div class="flex flex-col overflow-hidden">
                                ...
                                >
                                    <div class="flex items-center space-x-3">
                                        ...
                                        >
                                            <i class="fa fa-user-edit text-secondary dark:text-secondary-light" />
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        >
                                            <i class="fa-solid fa-image text-primary dark:text-accent-light" />
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        >
                                            <i class="fa fa-leaf text-success" />
                                        </div>
                                        <div>
                                            <p class="font-medium text-slate-600 dark:text-navy-100">
                                                Design Completed
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        >
                                            <i class="fa fa-project-diagram text-warning" />
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        >
                                            <i class="fa fa-history text-error" />
                                        </div>
                                        <div>
