...
<div id="right-sidebar" class="drawer drawer-right">
    <div class="drawer-overlay fixed inset-0 z-[150] hidden bg-slate-900/60" />
        ...
        >
                    ...
                    <div class="grid grid-cols-2 gap-3 px-3">
                        ...
                        <div class="rounded-lg bg-slate-150 px-2.5 py-2 dark:bg-navy-600">
                            ...
                            <div class="progress mt-3 h-1.5 bg-success/15 dark:bg-success/25">
                                <div class="relative w-6/12 overflow-hidden rounded-full bg-success" />
                            </div>
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center space-x-2">
                                <img class="h-10 w-10" src="images/100x100.png" alt="image" />
                                <div>
                                    <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">BTC</h2>
                                    <p class="text-xs">Bitcoin</p>
                                </div>
                            </div>

                            <div class="mt-2 flex items-center justify-between">
                                <p class="font-medium tracking-wide text-slate-700 dark:text-navy-100">60.33$</p>
                        ...
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center space-x-2">
                                <img class="h-10 w-10" src="images/100x100.png" alt="image" />
                                <div>
                                    <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">SOL</h2>
                                    <p class="text-xs">Solana</p>
                                </div>
                            </div>

                            <div class="mt-2 flex items-center justify-between">
                                <p class="font-medium tracking-wide text-slate-700 dark:text-navy-100">20.56$</p>
                ...
                <div class="mt-3 px-3">
                    <div class="rounded-lg bg-slate-100 p-3 dark:bg-navy-600">
                        ...
                        <div class="progress mt-2 h-2 bg-slate-150 dark:bg-navy-500">
                            <div class="w-7/12 rounded-full bg-info" />
                        </div>
                    </div>
                </div>
                <div class="h-18" />
            ...
            >
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="rounded-lg bg-slate-100 p-3 dark:bg-navy-600">
                        <div class="flex justify-between">
                            ...
                            <i class="fa fa-spinner text-base text-warning" />
                        </div>
                    ...
                    <div class="rounded-lg bg-slate-100 p-3 dark:bg-navy-600">
                        <div class="flex justify-between">
                            ...
                            <i class="fa-solid fa-list-check text-base text-info" />
                        </div>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    ...
                    <div class="mt-4">
                        <div class="progress h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div class="w-4/12 rounded-full bg-primary dark:bg-accent" />
                        </div>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    ...
                    <div class="mt-4">
                        <div class="progress h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div class="w-6/12 rounded-full bg-primary dark:bg-accent" />
                        </div>
                        <p class="mt-2 text-right text-xs+ font-medium text-primary dark:text-accent-light">
                            49%
                        </p>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    ...
                    <div class="mt-4">
                        <div class="progress h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div class="w-2/12 rounded-full bg-primary dark:bg-accent" />
                        </div>
                        <p class="mt-2 text-right text-xs+ font-medium text-primary dark:text-accent-light">
                            13%
                        </p>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    ...
                    <div class="mt-4">
                        <div class="progress h-1.5 bg-slate-150 dark:bg-navy-500">
                            <div class="w-9/12 rounded-full bg-primary dark:bg-accent" />
                        </div>
                        <p class="mt-2 text-right text-xs+ font-medium text-primary dark:text-accent-light">
                            78%
                        </p>
            ...
            >
                ...
                <ol class="timeline line-space mt-5 px-4 [--size:1.5rem]">
                    <li class="timeline-item">
                        ...
                        >
                            <i class="fa fa-user-edit text-tiny" />
                        </div>
                    ...
                    <li class="timeline-item">
                        ...
                        >
                            <i class="fa-solid fa-image text-tiny" />
                        </div>
                        <div class="timeline-item-content flex-1 pl-4">
                            <div class="flex flex-col justify-between pb-2 sm:flex-row sm:pb-0">
                                <p
                            ...
                            <div class="mt-4 grid grid-cols-3 gap-3">
                                <img class="rounded-lg" src="images/800x600.png" alt="image" />
                                <img class="rounded-lg" src="images/800x600.png" alt="image" />
                                <img class="rounded-lg" src="images/800x600.png" alt="image" />
                                <img class="rounded-lg" src="images/800x600.png" alt="image" />
                                <img class="rounded-lg" src="images/800x600.png" alt="image" />
                    ...
                    <li class="timeline-item">
                        ...
                        >
                            <i class="fa fa-project-diagram text-tiny" />
                        </div>
                        <div class="timeline-item-content flex-1 pl-4">
                            <div class="flex flex-col justify-between pb-2 sm:flex-row sm:pb-0">
                                <p
                    ...
                    <li class="timeline-item">
                        ...
                        >
                            <i class="fa fa-history text-tiny" />
                        </div>
                        <div class="timeline-item-content flex-1 pl-4">
                            <div class="flex flex-col justify-between pb-2 sm:flex-row sm:pb-0">
                                <p
